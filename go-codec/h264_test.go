...
func TestGetH264Resolution(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotWidth, gotHeight, _ := GetH264Resolution(tt.args.sps)
...
var want1 []byte = []byte{0x01, 0x64, 0x00, 0x0A, 0xFF, 0xE1, 0x00, 0x19, 0x67, 0x64, 0x00, 0x0A, 0xAC, 0x72, 0x84, 0x44,
	...
	// profile 100 extension (ISO 14496-15): chroma_format=1, bit_depth_luma/chroma_minus8=0, numOfSequenceParameterSetExt=0
	0xFD, 0xF8, 0xF8, 0x00}
