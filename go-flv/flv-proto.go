...
const (
	FLV_VIDEO_CODEC_UNKNOWN FLV_VIDEO_CODEC_ID = 0
...
const (
	FLV_SOUND_FORMAT_UNKNOWN FLV_SOUND_FORMAT = -1
...
// GetFLVVideoCodecId returns the codec id of a video tag body (legacy or
// enhanced header). FLV_VIDEO_CODEC_UNKNOWN is returned when the data is too
// short or the FourCC is not recognised.
